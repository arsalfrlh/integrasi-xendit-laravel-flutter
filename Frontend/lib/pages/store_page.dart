...
class StorePage extends StatefulWidget {
  StorePage({required this.payment});
  Payment payment;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Payment Store"),
      ),
      body: SafeArea(
        child: SizedBox(
...
class SignUpForm extends StatelessWidget {
  SignUpForm({required this.referenceID, required this.total, required this.store, required this.paymentCode, required this.expire});
  final TextEditingController referenceID, total, store, paymentCode, expire;
