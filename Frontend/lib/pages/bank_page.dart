...
class BankPage extends StatefulWidget {
  BankPage({required this.payment});
  Payment payment;
...
class _BankPageState extends State<BankPage> {
  ...
  void initState() {
    super.initState();
    referenceIDController = TextEditingController(text: widget.payment.referenceID);
    expireController = TextEditingController(text: formatted.format(widget.payment.expire));
    totalController = TextEditingController(text: widget.payment.total.toString());
    paymentCodeController = TextEditingController(text: widget.payment.paymentCode);
    if(widget.payment.bank == 'BCA'){
      ...
      bankController = TextEditingController(text: "Bank CIMB Niaga");
    }else if(widget.payment.bank == 'MANDIRI'){
      bankController = TextEditingController(text: "Bank Mandiri");
    }else{
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  SignUpForm(
                    referenceID: referenceIDController,
...
class SignUpForm extends StatelessWidget {
  SignUpForm({required this.referenceID, required this.total, required this.bank, required this.paymentCode, required this.expire});
  final TextEditingController referenceID, total, bank, paymentCode, expire;
